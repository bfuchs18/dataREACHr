#' json_sst_byrun: Generates json file for the derivative SST behavioral data by run
#'
#' This function generates a json file for SST summary data in long format by run
#'
#' @return a json file for SST summary data in long format by run
#'
#'
#' @export

json_sst_byrun <- function() {
  ...
  sst_byrun_list <- list(
    ...
    'FileLevelMetadata' = list(
      Description = 'SST behavior summarized by run',
