...
util_redcap_parent_v3 <- function(data, return_data = TRUE) {
  ...
  spsrq_scored <- dataprepr::score_spsrq(spsrq_data, base_zero = TRUE, id = 'participant_id', extra_scale_cols = c("spsrq_form_date"))
  ...
  pwlb_scored <- dataprepr::score_pwlb(pwlb_data, base_zero = TRUE, id = 'participant_id', extra_scale_cols = c("pwlb_form_date", "pwlb_24a"))
  ...
  tfeq_scored <- dataprepr::score_tfeq18(tfeq_data, base_zero = TRUE, id = 'participant_id', extra_scale_cols = c("tfeq_form_date"))
  ...
  bisbas_scored <- dataprepr::score_bisbas(bisbas_data, base_zero = TRUE, id = 'participant_id', extra_scale_cols = c("bisbas_form_date"))
