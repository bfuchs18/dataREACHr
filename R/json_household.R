...
json_household <- function() {
  ...
  household_list <- list(
    ...
    visit_data = list( Description = 'Date of visit when this parent-reported assessment was complete'),
    ...
    demo_income = list( Description = 'Including ALL sources (such as social security income, child support payments, government assistance, dividends from investments, etc.) what was your household\'s combined yearly income last year BEFORE taxes?',
                        Levels = list ('0' = 'Less than $20,000',
                                       ...
                                       '4' = '$76,000 - $100,000',
                                       '5' = '$100,000 +')),
    demo_education_mom = list( Description = 'What is the child\'s biological mother\'s highest level of formal education?',
                               Levels = list ('0' = 'None',
                                              '1' = 'Preschool',
                                              '2' = 'Kindergarten',
                                              '3' = '1st grade',
    ...
    demo_lost_weight_one_year = list( Description = 'Have you or your spouse, partner, or significant other lost more than ten pounds in the past year, excluding weight from pregnancy?',
                                      Levels = list ('0' = 'No',
                                                     '1' = 'Yes')),
    demo_parent2_reported_height_ft = list( Description = 'What is your child\'s biological parent\'s height who was not measured or present at today\'s visit (Feet):'),
    demo_parent2_reported_height_in = list( Description = 'What is your child\'s biological parent\'s height who was not measured or present at today\'s visit (Inches):'),
    ...
    demo_parent_age = list( Description = 'Age of parent calculated from self-reported parent date of birth (data not shared) and date of form completion (data not shared)',
                            Unit = "years",
                            Derivative = TRUE),
    demo_parent2_reported_height_m = list( Description = 'Parent2 (i.e., biological parent not at visit) height calculated from demo_parent2_reported_height_ft_component and demo_parent2_reported_height_inch_component',
                            Unit = "meters",
                            Derivative = TRUE),
    demo_parent2_reported_bmi = list( Description = 'Parent2 (i.e., biological parent not at visit) BMI calculated from parent2_reported_height_m and demo_parent2_reported_weight_lbs',
                            Unit = "kg/m^2",
                            Derivative = TRUE))
