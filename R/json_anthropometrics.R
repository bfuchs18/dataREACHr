...
json_anthropometrics <- function() {
  ...
  anthro_list <- list(
    ...
    child_bmi_z = list( Description = 'Child BMI-for-age z-score baesd on the LMS Parameters for the Centers for Disease Control and Prevention 2000 Growth Charts. Calculated in R using childsds package',
                        Derivative = TRUE),
    demo_child_relationship = list(Description = 'Child relationship of adult completing the household demographics form where parent2 anthropometrics were reported. Also found in household.tsv.',
