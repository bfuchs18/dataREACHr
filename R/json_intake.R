...
json_intake <- function() {
  ...
  intake_list <- list(
    ...
    liking_visit_protocol = list( Description = 'REACH child protocol visit that VAS food liking ratings were collected on',
                                  Levels = list ('1' =	'Child visit protocol 1',
                                                 '5'	= 'Child visit protocol 5')),
    ...
    water_eah_kcal_consumed = list( Description = 'Energy of water consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    meal_grams_consumed = list( Description = 'Total weight of food consumed during test meal (does not include water)',
                                     Derivative = TRUE,
                                     Unit = "grams"),
    ...
    meal_kcal_consumed = list( Description = 'Total energy of food consumed during test meal',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    eah_grams_consumed = list( Description = 'Total weight of food consumed during EAH (does not include water)',
                                     Derivative = TRUE,
                                     Unit = "grams"),
    ...
    eah_kcal_consumed = list( Description = 'Total energy of food consumed during EAH',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    total_grams_consumed = list( Description = 'Total weight of food consumed during test meal and EAH (does not include water)',
                               Derivative = TRUE,
                               Unit = "grams"),
