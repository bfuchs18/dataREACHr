...
json_intake <- function() {
  ...
  intake_list <- list(
    ...
    grilled_cheese_post_w_plate = list( Description = 'Post-meal weight of grilled cheese with plate',
                                        Unit = "grams"),
    grilled_cheese_grams_consumed = list( Description = 'Weight of grilled cheese consumed during meal',
                                          Unit = "grams",
                                          Derivative = TRUE),
    ...
    tender_post_w_plate = list( Description = 'Post-meal weight of chicken tender with plate',
                                Unit = "grams"),
    tender_grams_consumed = list( Description = 'Weight of chicken tender consumed during meal',
                                  Unit = "grams",
                                  Derivative = TRUE),
    ...
    carrot_post_w_plate = list( Description = 'Post-meal weight of carrots with plate',
                                Unit = "grams"),
    carrot_grams_consumed = list( Description = 'Weight of carrots consumed during meal',
                                  Unit = "grams",
                                  Derivative = TRUE),
    ...
    chips_post_w_plate = list( Description = 'Post-meal weight of potato chips with plate',
                               Unit = "grams"),
    chips_grams_consumed = list( Description = 'Weight of potato chips consumed during meal',
                                 Unit = "grams",
                                 Derivative = TRUE),
    ...
    fruit_post_w_plate = list( Description = 'Post-meal weight of fruit cocktail with plate',
                               Unit = "grams"),
    fruit_grams_consumed = list( Description = 'Weight of fruit cocktail consumed during meal',
                                 Unit = "grams",
                                 Derivative = TRUE),
    ...
    water_post_w_plate = list( Description = 'Post-meal weight of water with container',
                               Unit = "grams"),
    water_grams_consumed = list( Description = 'Weight of water consumed during meal',
                                 Unit = "grams",
                                 Derivative = TRUE),
    ...
    ranch_post_w_plate = list( Description = 'Post-meal weight of ranch dressing with container',
                               Unit = "grams"),
    ranch_grams_consumed = list( Description = 'Weight of ranch dressing consumed during meal',
                                 Unit = "grams",
                                 Derivative = TRUE),
    ...
    brownie_post_w_plate = list( Description = 'Post-EAH weight of brownies with plate',
                                 Unit = "grams"),
    brownie_grams_consumed = list( Description = 'Weight of brownies consumed during EAH protocol',
                                   Unit = "grams",
                                   Derivative = TRUE),
    ...
    corn_chip_post_w_plate = list( Description = 'Post-EAH weight of corn chips with plate',
                                   Unit = "grams"),
    corn_chip_grams_consumed = list( Description = 'Weight of corn chips consumed during EAH protocol',
                                     Unit = "grams",
                                     Derivative = TRUE),
    ...
    kiss_post_w_plate = list( Description = 'Post-EAH weight of Hersheys kiss with plate',
                              Unit = "grams"),
    kiss_grams_consumed = list( Description = 'Weight of Hersheys kiss consumed during EAH protocol',
                                Unit = "grams",
                                Derivative = TRUE),
