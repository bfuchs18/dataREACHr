...
json_intake <- function() {
  ...
  intake_list <- list(
    ...
    vas_visit = list( Description = 'REACH child protocol visit that VAS food liking ratings were collected on',
                      Levels = list ('1' =	'Child visit protocol 1',
                                     '5'	= 'Child visit protocol 5')),
    ...
    water_pre_w_o_plate = list( Description = 'Pre-EAH weight of water without container',
                                    Unit = "grams"),
    water_pre_w_plate = list( Description = 'Pre-EAH weight of water with container',
                                  Unit = "grams"),
    water_post_w_plate = list( Description = 'Post-EAH weight of water with container',
                                   Unit = "grams"),
    ...
    grilled_cheese_grams_consumed = list( Description = 'Weight of grilled_cheese consumed during test meal. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                              Derivative = TRUE,
                              Unit = "grams"),
    grilled_cheese_kcal_consumed = list( Description = 'Energy of grilled_cheese consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                         Derivative = TRUE,
                                         Unit = "kcal"),
    tender_grams_consumed = list( Description = 'Weight of chicken tender consumed during test meal Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                          Derivative = TRUE,
                                          Unit = "grams"),
    tender_kcal_consumed = list( Description = 'Energy of chicken tender consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                         Derivative = TRUE,
                                         Unit = "kcal"),
    carrot_grams_consumed = list( Description = 'Weight of carrots consumed during test meal. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    carrot_kcal_consumed = list( Description = 'Energy of carrots consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    chips_grams_consumed = list( Description = 'Weight of chips consumed during test meal. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    chips_kcal_consumed = list( Description = 'Energy of chips consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    fruit_grams_consumed = list( Description = 'Weight of fruit consumed during test meal. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    fruit_kcal_consumed = list( Description = 'Energy of fruit consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    water_grams_consumed = list( Description = 'Weight of water consumed during test meal. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    water_kcal_consumed = list( Description = 'Energy of water consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    ranch_grams_consumed = list( Description = 'Weight of ranch consumed during test meal. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    ranch_kcal_consumed = list( Description = 'Energy of ranch consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    ketchup_grams_consumed = list( Description = 'Weight of ketchup consumed during test meal. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    ketchup_kcal_consumed = list( Description = 'Energy of ketchup consumed during test meal. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    brownie_grams_consumed = list( Description = 'Weight of brownies consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    brownie_kcal_consumed = list( Description = 'Energy of brownies consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    corn_chip_grams_consumed = list( Description = 'Weight of corn chips consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    corn_chip_kcal_consumed = list( Description = 'Energy of corn chips consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    kiss_grams_consumed = list( Description = 'Weight of Hershey\'s kisses consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    kiss_kcal_consumed = list( Description = 'Energy of Hershey\'s kisses consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    ice_cream_grams_consumed = list( Description = 'Weight of ice cream consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                  Derivative = TRUE,
                                  Unit = "grams"),
    ice_cream_kcal_consumed = list( Description = 'Energy of ice cream consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                 Derivative = TRUE,
                                 Unit = "kcal"),
    oreo_grams_consumed = list( Description = 'Weight of oreos consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                     Derivative = TRUE,
                                     Unit = "grams"),
    oreo_kcal_consumed = list( Description = 'Energy of oreos consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    popcorn_grams_consumed = list( Description = 'Weight of popcorn consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                Derivative = TRUE,
                                Unit = "grams"),
    popcorn_kcal_consumed = list( Description = 'Energy of popcorn consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                               Derivative = TRUE,
                               Unit = "kcal"),
    pretzel_grams_consumed = list( Description = 'Weight of pretzels consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                     Derivative = TRUE,
                                     Unit = "grams"),
    pretzel_kcal_consumed = list( Description = 'Energy of pretzels consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    skittle_grams_consumed = list( Description = 'Weight of skittles consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                   Derivative = TRUE,
                                   Unit = "grams"),
    skittle_kcal_consumed = list( Description = 'Energy of skittles consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                  Derivative = TRUE,
                                  Unit = "kcal"),
    starburst_grams_consumed = list( Description = 'Weight of starbursts consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                   Derivative = TRUE,
                                   Unit = "grams"),
    starburst_kcal_consumed = list( Description = 'Energy of starbursts consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                  Derivative = TRUE,
                                  Unit = "kcal"),
    water_eah_grams_consumed = list( Description = 'Weight of water consumed during EAH. Computed by subtracting [item]_post_w_plate from [item]_pre_w_plate',
                                     Derivative = TRUE,
                                     Unit = "grams"),
    water_eah_kcal_consumed = list( Description = 'Energy of water consumed during EAH. Computed by multiplying [item]_grams_consumed by [item] energy density',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    meal_grams_consumed = list( Description = 'Total weight of food consumed during test meal',
                                     Derivative = TRUE,
                                     Unit = "grams"),
    meal_grams_consumed_inc_water = list( Description = 'Total weight of food and water consumed during test meal',
                                Derivative = TRUE,
                                Unit = "grams"),
    meal_kcal_consumed = list( Description = 'Total energy of food consumed during test meal',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    eah_grams_consumed = list( Description = 'Total weight of food consumed during EAH',
                                     Derivative = TRUE,
                                     Unit = "grams"),
    eah_grams_consumed_inc_water = list( Description = 'Total weight of food and water consumed during EAH',
                                          Derivative = TRUE,
                                          Unit = "grams"),
    eah_kcal_consumed = list( Description = 'Total energy of food consumed during EAH',
                                    Derivative = TRUE,
                                    Unit = "kcal"),
    total_grams_consumed = list( Description = 'Total weight of food consumed during test meal and EAH',
                               Derivative = TRUE,
                               Unit = "grams"),
    total_grams_consumed_inc_water = list( Description = 'Total weight of food and water consumed during test meal and EAH',
                                 Derivative = TRUE,
                                 Unit = "grams"),
