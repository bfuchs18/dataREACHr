...
#'
#' @return A json file documenting the raw inputs and scored values for the Comprehensive Feeding Practices Questionnaire
#'
#'
#' @export
...
json_cfpq <- function() {
  ...
  cfpq_list <- list(
    'MeasurementToolMetadata' = list(
      Description = '. Participants were provided the following instructions: "Please answer the following questions about your child:"',
      Reference = '',
      TermURL = ''),
